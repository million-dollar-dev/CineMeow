...
const MediaCarousel = ({title}) => {
    ...
    return (
        <section className="py-[2vw] bg-cover bg-center bg-no-repeat py-20 px-4 w-full bg-[url('https://homepage.momocdn.net/img/momo-upload-api-230912110927-638301137672516955.jpeg')]" >
