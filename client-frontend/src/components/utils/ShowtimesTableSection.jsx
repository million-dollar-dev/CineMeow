    ...
    return (
        <div className="my-[4vw]">
            ...
            <div className="border border-gray-light rounded-md max-w-screen-xl mx-auto bg-gray-dark">
                <div className="border-b py-[2vw]">
                    <div className="flex gap-[0.4vw] items-center border-b-1 pb-[2vw] px-[2vw]">
                        <p>Vị trí</p>
                        <button
                    ...
                    <div>
                        <div className="flex gap-[1vw] justify-center mt-[2vw]">
                            {
                                cinemaData.map((c) => {
                ...
                <div className="flex">
                    <div className="flex-col gap-[0.4vw] items-center flex-1">
                        ...
                        <button
                            className="bg-gray-sub flex items-center gap-[2vw] px-[1.4vw] py-[1vw] w-full border border-gray-light justify-between">
                    ...
                    <div className="flex-[2] border-l">
                        <div className="flex gap-[1vw] items-center py-[2vw] px-[2vw] bg-gray-sub">
                            ...
                            <div>
                                <a href="" className="hover:text-violet font-bold">Lịch chiếu phim CGV Hùng Vương
                                    Plaza</a>
                                <div className="text-gray-light">Tầng 7 | Hùng Vương Plaza 126 Hùng Vương Quận 5 Tp. Hồ
                                    Chí Minh
